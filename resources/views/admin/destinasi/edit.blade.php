                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="kategori" required>
                                        ...
                                        <option value="Pulau" {{ old('kategori', $destinasi->kategori) == 'Pulau' ? 'selected' : '' }}>Pulau</option>
                                        <option value="Air Terjun" {{ old('kategori', $destinasi->kategori) == 'Air Terjun' ? 'selected' : '' }}>Air Terjun</option>
                                        <option value="Danau" {{ old('kategori', $destinasi->kategori) == 'Danau' ? 'selected' : '' }}>Danau</option>
                                        <option value="Waterpark" {{ old('kategori', $destinasi->kategori) == 'Waterpark' ? 'selected' : '' }}>Waterpark</option>
                                        <option value="Hutan Mangrove" {{ old('kategori', $destinasi->kategori) == 'Hutan Mangrove' ? 'selected' : '' }}>Hutan Mangrove</option>
                                    </select>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('website') is-invalid @enderror" 
                                           name="website" value="{{ old('website', $destinasi->website) }}" placeholder="https://example.com atau www.example.com">
                                    @error('website')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        @php
                                            $dbFasilitas = \App\Models\Fasilitas::orderBy('nama_fasilitas')->pluck('nama_fasilitas')->toArray();
                                            $selectedFasilitas = $destinasi->fasilitas ?? [];
                                            $fasilitasOptions = array_values(array_unique(array_merge($dbFasilitas, $selectedFasilitas)));
